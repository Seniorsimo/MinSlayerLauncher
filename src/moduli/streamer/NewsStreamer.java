 ...
 * @author simone
 */
public class NewsStreamer extends Streamer{
    
    private StreamerListener gui;

    public NewsStreamer(StreamerListener gui) {
        this.gui = gui;
    }
    ...
    public void getData() {
        ...
        try {
            url = new URL("http://minslayer.playat.ch/category/news/feed/");
...
//                System.out.println("descrizione:" + entry.getDescription().getValue()+"n");
    ...
    public class Post{
        ...
        private Post(String title, String link, Date publishedDate, String value) {
            this.title = title;
            this.link = link;
